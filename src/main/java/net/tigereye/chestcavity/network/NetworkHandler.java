...
public final class NetworkHandler {
    ...
    public static void init() {
        ...
        CHANNEL.messageBuilder(OrganDataPacket.class, index++, NetworkDirection.LOGIN_TO_CLIENT).encoder(OrganDataPacket::encode).decoder(OrganDataPacket::decode).consumer(OrganDataPacket::handle).add();
